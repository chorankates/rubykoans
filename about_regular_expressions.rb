...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  #
  # Why?
  #   because unless they are bound by ?, they match as many characters as possible
  ...
  #   uhh.. it's in the definition.. a character class is a class, alternation uses strings.
