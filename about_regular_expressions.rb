...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # when part of a larger 'equation'? that is a stupid question
  ...
  # because unless they are bounded with '?', they match as many characters as possible. this is typically important when talking about '.'
  ...
  # alternation has the added value of order, though character class has greater flexibility
