...
class AboutControlStatements < EdgeCase::Koan
  ...
  def test_unless_statement
    result = :default_value # below comment is theirs, not mine
  ...
  def test_while_statement
    ...
    assert_equal 3628800, result # cheater
  end
  ...
  def test_for_statement
    ...
    result = []
    for item in array
      result << item.upcase # which is the method that does sentence case?
    end
