...
It was the worst of times.
    ...
    assert_equal 54, long_string.length # this is stupid
...
It was the worst of times.
EOS
    assert_equal 53, long_string.length # this is even more stupid.
    assert_equal 2, long_string.lines.count # are you kidding me
    assert_equal "I", long_string[0,1] # wat <-- so this is a string, but previous test gave us an array, makes sense
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # because it modifies the string in place.. not sure that's a good generalization though
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # only because that's stupid.. if i wanted that, i'd call .to_ascii or something similar
