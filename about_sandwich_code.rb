...
class AboutSandwichCode < EdgeCase::Koan
  ...
  def count_lines(file_name)
    ...
    count # if we get here, return count.. ensure block runs after this (?)
  ensure
    file.close if file
  end
  ...
  def test_counting_lines2
    assert_equal 4, count_lines2("example_file.txt") # so this is cool, but not actually that much more efficient
  end
