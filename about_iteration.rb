...
class AboutIteration < Neo::Koan
  ...
  def test_find_locates_the_first_element_matching_a_criteria
    ...
    assert_equal 'Clarence', array.find { |item| item.size > 4 } # this is a stupid test, clarence is the only one above 4 characters
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # takes the result of the previous iteration and passes it back into the current iteration
  end
