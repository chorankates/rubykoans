...
class AboutObjects < EdgeCase::Koan
  ...
  def test_small_integers_have_fixed_ids
    ...
    # THINK ABOUT IT:
    # What pattern do the object IDs for small integers follow? --> 1 based +2
  end
  ...
  def test_clone_creates_a_different_object
    ...
    # so isn't this really an alias? -- no, a clone copies the object id, and alias only copies the object
  end
end
